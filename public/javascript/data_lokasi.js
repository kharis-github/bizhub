// File ini menyimpan semua data lokasi untuk keperluan field lokasi pada form new business

// 1) Array of `province` objects, dimana setiap object berstruktur 'name', 'iso_code'
const array_provinsi = [
    {
        'name': 'Aceh',
        'iso_code': 'AC',
    },
...
// 2) object of keys and array values for provinsi dan kabupatennya
const array_kabupaten = {
...
// 3) object of keys and array values for kabupaten dan kecamatannya
const array_kecamatan = {
    // Aceh
    'kabupaten-simeulue': [
        'Alafan',
        'Salang',
